...
export class AudioProvider {
  ...
  playRougeSound() {
    this.nativeAudio.play('rogueAgentAudio', () => console.log('rougeSound is done playing'));
  }

  playAgentSound() {
    this.nativeAudio.play('007AgentAudio', () => console.log('agentSound is done playing'));
  }
